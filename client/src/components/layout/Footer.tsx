            ...
            <div className="container">
                <div className="grid grid-cols-[repeat(auto-fit,minmax(190px,1fr))] gap-10 pb-12 border-b border-[#EEEEEE]">
                    ...
                    <div>
                        <Link to="/" className="flex items-center gap-[0.5rem] no-underline mb-4 group">
                            <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#0F7A49] via-[#16A34A] to-[#34D399] flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110" style={{ boxShadow: '0 2px 8px rgba(22,163,74,0.2)' }}>
                                <ChefHat size={16} />
                            </span>
                        ...
                        <div className="flex flex-col gap-[0.65rem]">
                            {[{ to: '/', l: 'Home' }, { to: '/menu', l: 'Menu' }, { to: '/cart', l: 'Cart' }, { to: '/profile', l: 'My Account' }].map((i) => (
                                <Link
                                    key={i.to}
                                    to={i.to}
                                    className="text-[#4A4A4A] text-[0.85rem] no-underline font-medium hover:text-[#16A34A] transition-colors duration-200"
                                >
                                    {i.l}
                                </Link>
                            ))}
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-[0.7rem] text-[0.85rem] text-[#4A4A4A]">
                            {[
                                ...
                                { Icon: Mail, text: 'gauricafe@gmail.com' },
                                { Icon: MapPin, text: 'Abes Engineering college, Ghaziabad' },
                            ].map((c) => (
                                 <div key={c.text} className="flex items-center gap-[0.6rem]">
                                    <span className="w-7 h-7 rounded-lg bg-[#ECFDF5] flex items-center justify-center text-[#16A34A] flex-shrink-0">
                                        <c.Icon size={13} />
                                    </span>
                                    {c.text}
                                </div>
                ...
                <div className="py-5 flex justify-between items-center flex-wrap gap-3">
                    <p className="text-[0.75rem] text-[#8E8E8E]">
                        &copy; {year} CampusBites. All rights reserved.
                    </p>
                    <div className="flex gap-5">
                        {[
                            ...
                            <span
                                key={t.label}
                                className="flex items-center gap-[0.35rem] text-[0.75rem] text-[#8E8E8E] cursor-pointer hover:text-[#16A34A] transition-colors duration-200"
                            >
