        ...
        >
            <div>
                <p style={{ fontSize: '0.68rem', opacity: 0.55, fontWeight: 500, lineHeight: 1, marginBottom: 3 }}>
                    {itemCount} item{itemCount !== 1 ? 's' : ''} • Pay Online
                </p>
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#F4F4F2', paddingBottom: 84 }} className="page-enter">
            ...
            <div style={{ maxWidth: 560, margin: '0 auto', padding: '1.25rem clamp(0.75rem, 3vw, 1.5rem)' }}>
                ...
                {/* ── Order Items Card ────────────────────────────── */}
                <div style={{ background: 'white', borderRadius: 18, overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginBottom: '0.75rem' }}>
                    <div style={{ padding: '0.8rem 1.15rem', borderBottom: '1px solid #F0F0EE', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <span style={{ width: 26, height: 26, borderRadius: 7, background: '#ECFDF5', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#16A34A', flexShrink: 0 }}>
                            <UtensilsCrossed size={12} />
                        </span>
                        <span style={{ fontWeight: 800, fontSize: '0.78rem', color: '#0F0F0F', letterSpacing: '0.04em' }}>ORDER SUMMARY</span>
                    ...
                    <div style={{ padding: '0.65rem 1.15rem' }}>
                        {items.map((item, idx) => (
                            <div key={item.cartItemId}>
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.55rem 0', gap: '0.5rem' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flex: 1, minWidth: 0 }}>
                                        <span style={{ width: 11, height: 11, borderRadius: 2, border: `1.5px solid ${item.isVeg ? '#16A34A' : '#DC2626'}`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                            <span style={{ width: 5, height: 5, borderRadius: '50%', background: item.isVeg ? '#16A34A' : '#DC2626' }} />
                                        </span>
                                        <span style={{ fontSize: '0.82rem', fontWeight: 600, color: '#0F0F0F', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{item.name}</span>
                                        <span style={{ fontSize: '0.72rem', color: '#8E8E8E', flexShrink: 0 }}>×{item.quantity}</span>
                                    </div>
                                    <span style={{ fontWeight: 700, fontSize: '0.82rem', color: '#0F0F0F', flexShrink: 0 }}>₹{item.itemTotal}</span>
                                </div>
                                ...
                                {idx < items.length - 1 && (<div style={{ borderTop: '1px dashed #EEEEEE' }} />)}
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div style={{ background: 'white', borderRadius: 18, overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginBottom: '0.75rem' }}>
                    <div style={{ padding: '0.8rem 1.15rem', borderBottom: '1px solid #F0F0EE', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <span style={{ width: 26, height: 26, borderRadius: 7, background: '#EFF6FF', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#2563EB', flexShrink: 0 }}>
                            <CreditCard size={12} />
                        </span>
                        <span style={{ fontWeight: 800, fontSize: '0.78rem', color: '#0F0F0F', letterSpacing: '0.04em' }}>PAYMENT METHOD</span>
                    </div>
                    <div style={{ padding: '0.75rem 1.15rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        {/* ONLINE — Active */}
                        <button style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem', borderRadius: 14, width: '100%', border: '2px solid #16A34A', background: '#ECFDF5', cursor: 'default', textAlign: 'left', transition: 'all 0.15s' }}>
                            <span style={{ width: 18, height: 18, borderRadius: '50%', border: '2px solid #16A34A', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                <span style={{ width: 10, height: 10, borderRadius: '50%', background: '#16A34A' }} />
                            </span>
                            <span style={{ width: 36, height: 36, borderRadius: 10, background: '#F0FDF4', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#16A34A', flexShrink: 0 }}>
                                <CreditCard size={17} />
                            </span>
                            <div style={{ flex: 1 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem', borderRadius: 14, width: '100%', border: '2px solid #EEEEEE', background: '#FAFAF8', opacity: 0.35, cursor: 'not-allowed', textAlign: 'left', position: 'relative' }}>
                            <span style={{ width: 18, height: 18, borderRadius: '50%', border: '2px solid #D4D4D0', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }} />
                            <span style={{ width: 36, height: 36, borderRadius: 10, background: '#EFF6FF', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#2563EB', flexShrink: 0 }}>
                                <Banknote size={17} />
                            </span>
                            <div style={{ flex: 1 }}>
                            ...
                            <span style={{ display: 'flex', alignItems: 'center', gap: 3, padding: '3px 8px', borderRadius: 6, background: '#DCFCE7', color: '#166534', fontSize: '0.62rem', fontWeight: 700, letterSpacing: '0.02em', flexShrink: 0 }}>
                ...
                {/* ── Bill Details Card ───────────────────────────── */}
                <div style={{ background: 'white', borderRadius: 18, overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginBottom: '0.75rem' }}>
                    <div style={{ padding: '0.8rem 1.15rem', borderBottom: '1px dashed #D4D4D0', fontWeight: 800, fontSize: '0.78rem', color: '#0F0F0F', letterSpacing: '0.04em' }}>
                        BILL DETAILS
                    </div>
                ...
                {/* ── Secure badge ────────────────────────────────── */}
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', padding: '0.75rem 0', opacity: 0.45 }}>
                    <Lock size={11} />
